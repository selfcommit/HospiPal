...
class Patient(models.Model):
    ...
    hdl = models.CharField(max_length=33, blank=True)
    ldl = models.CharField(max_length=33, blank=True)
    tri = models.CharField(max_length=33, blank=True)
    blood_sugar = models.CharField(max_length=33, blank=True)
